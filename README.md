...
AI assistant for property search and analysis.

Helps users review listings, compare properties, and pull out useful details faster.

**Stack:** Python, OpenAI API

---

For larger scale work, see the [M365 LangChain Agent](https://github.com/NeerajMohanty/m365-langchain-agent), a RAG agent built for Microsoft 365 on Azure.
